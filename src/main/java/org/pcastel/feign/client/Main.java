...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // Get Client
        final CatClient client = Feign.builder()
...
//                .logger(new Slf4jLogger())
        ...
        // Find All
//        final String catString = client.findAll();
//        System.out.println(catString);

        // Find All
//        final List<Cat> cats = client.findAll();
//        cats.forEach(System.out::println);
//        System.out.println();

        // Find by id
//        final String id = cats.stream().map(Cat::getId).findFirst().orElse(null);
//        final Cat c = client.findById(id);
